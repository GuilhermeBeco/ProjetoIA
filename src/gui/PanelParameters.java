...
public class PanelParameters extends PanelAtributesValue {
    ...
    String[] recombinationMethods = {"PMX", "Recombination 3", "Recombination 2","Recombination 4"};
    ...
    String[] mutationMethods = {"Insert", "Mutation3", "Mutation2","Mutation 4"};
    ...
    public Recombination<CatchIndividual, CatchProblemForGA> getRecombinationMethod() {
        ...
        switch (comboBoxRecombinationMethods.getSelectedIndex()) {
            ...
            case 3:
                return new Recombination4<>(recombinationProb);
        }
        return null;
    }
